...
import com.example.user.trucksales.Visual.TruckSales.IngresarTarjetaDebitoTruckSales;

import java.util.List;

public class AdaptadorTarjetaDebitoTruckSales extends BaseAdapter {
    ...
    private final AdaptadorTarjetaDebitoTruckSales adaptador;
    private IngresarTarjetaDebitoTruckSales activity; //Activity desde el cual se hace referencia al llenado de la lista
    private List<TarjetaDebito> arrayItems; // Lista de items


    // Constructor con parámetros que recibe la Acvity y los datos de los items.
    public AdaptadorTarjetaDebitoTruckSales(IngresarTarjetaDebitoTruckSales activity, List<TarjetaDebito> items){
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final TarjetaDebito itm = arrayItems.get(position);
        ...
        if(convertView==null)      {
            convertView = inflator.inflate(R.layout.item_tarjetadebito, parent, false);
        ...
        if (itm.getCod_Mon().trim().equals("1")){
        ...
        */
        ...
        view.ico_eliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WebService.removeTarjetaDebito(itm);
