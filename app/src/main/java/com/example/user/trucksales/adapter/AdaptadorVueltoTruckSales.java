...
import com.example.user.trucksales.Visual.TruckSales.IngresarVueltoTruckSales;

import java.util.List;

public class AdaptadorVueltoTruckSales extends BaseAdapter {
    ...
    private final AdaptadorVueltoTruckSales adaptador;
    private IngresarVueltoTruckSales activity; //Activity desde el cual se hace referencia al llenado de la lista
    private List<Vuelto> arrayItems; // Lista de items

    public AdaptadorVueltoTruckSales(IngresarVueltoTruckSales activity, List<Vuelto> items){
        super();
