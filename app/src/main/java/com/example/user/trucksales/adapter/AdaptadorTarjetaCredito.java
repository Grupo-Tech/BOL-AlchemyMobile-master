...
public class AdaptadorTarjetaCredito extends BaseAdapter {
    ...
    private final AdaptadorTarjetaCredito adaptador;
    private IngresarTarjetaCredito activity; //Activity desde el cual se hace referencia al llenado de la lista
    ...
    public AdaptadorTarjetaCredito(IngresarTarjetaCredito activity, List<TarjetaCredito> items){
        super();
