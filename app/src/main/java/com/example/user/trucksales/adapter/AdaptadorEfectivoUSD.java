...
import com.example.user.trucksales.Visual.Cobranza.IngresarEfectivoUSD;
...
public class AdaptadorEfectivoUSD extends BaseAdapter {
    ...
    private final AdaptadorEfectivoUSD adaptador;
    private IngresarEfectivoUSD activity; //Activity desde el cual se hace referencia al llenado de la lista
    ...
    public AdaptadorEfectivoUSD(IngresarEfectivoUSD activity, List<EfectivoUSD> items){
        super();
