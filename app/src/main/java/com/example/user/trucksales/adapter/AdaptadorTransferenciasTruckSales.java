...
import com.example.user.trucksales.Visual.TruckSales.IngresarTransferenciasTruckSales;

import java.util.List;

public class AdaptadorTransferenciasTruckSales extends BaseAdapter {
    ...
    private final AdaptadorTransferenciasTruckSales adaptador;
    private IngresarTransferenciasTruckSales activity; //Activity desde el cual se hace referencia al llenado de la lista
    ...
    public AdaptadorTransferenciasTruckSales(IngresarTransferenciasTruckSales activity, List<Transferencias> items){
        super();
