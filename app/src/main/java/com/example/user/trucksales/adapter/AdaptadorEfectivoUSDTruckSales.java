...
import com.example.user.trucksales.Visual.TruckSales.IngresarEfectivoUSDTruckSales;

import java.util.List;

public class AdaptadorEfectivoUSDTruckSales extends BaseAdapter {
    ...
    private final AdaptadorEfectivoUSDTruckSales adaptador;
    private IngresarEfectivoUSDTruckSales activity; //Activity desde el cual se hace referencia al llenado de la lista
    private List<EfectivoUSD> arrayItems; // Lista de items


    // Constructor con parámetros que recibe la Acvity y los datos de los items.
    public AdaptadorEfectivoUSDTruckSales(IngresarEfectivoUSDTruckSales activity, List<EfectivoUSD> items){
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final EfectivoUSD itm = arrayItems.get(position);
        ...
        if(convertView==null)      {
            convertView = inflator.inflate(R.layout.items_efectivousd, parent, false);
        ...
        view.txtImporte.setText("U$S "+importe);
        ...
        */
        ...
        view.ico_eliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WebService.removeEfectivoUSD(itm);
