...
import com.example.user.trucksales.Visual.Cobranza.IngresarRetenciones;
import com.example.user.trucksales.Visual.TruckSales.IngresarRetencionesTruckSales;

import java.util.List;

public class AdaptadorRetencionesTruckSales extends BaseAdapter {
    ...
    private final AdaptadorRetencionesTruckSales adaptador;
    private IngresarRetencionesTruckSales activity; //Activity desde el cual se hace referencia al llenado de la lista
    private List<Retenciones> arrayItems; // Lista de items


    // Constructor con parámetros que recibe la Acvity y los datos de los items.
    public AdaptadorRetencionesTruckSales(IngresarRetencionesTruckSales activity, List<Retenciones> items){
        super();
    ...
    public static class Fila   {
        ...
        public TextView txtDetalle,txtFecha,txtImporte;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Retenciones itm = arrayItems.get(position);
        ...
        if(convertView==null)      {
            convertView = inflator.inflate(R.layout.items_retenciones, parent, false);
        ...
        if(WebService.configuracion.getReten_completa().equals("N")){
            view.txtDetalle.setText(itm.getDetalle().trim());
        }
        else {
            view.txtDetalle.setText(itm.getSuc_ref() + itm.getFac_ref() + itm.getDetalle().trim());
        }
        ...
        view.txtImporte.setText("TC" + itm.getTipo_cambio() + WebService.simboloMonedaNacional+" "+importe);
        ...
        */
        ...
        view.ico_eliminar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WebService.removeRetenciones(itm);
