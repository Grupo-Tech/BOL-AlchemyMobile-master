...
import com.example.user.trucksales.Visual.TruckSales.IngresarChequesTruckSales;

import java.util.List;

public class AdaptadorChequesTruckSales extends BaseAdapter {
    ...
    private final AdaptadorChequesTruckSales adaptador;
    private IngresarChequesTruckSales activity; //Activity desde el cual se hace referencia al llenado de la lista
    private List<Cheque> arrayItems; // Lista de items


    // Constructor con parámetros que recibe la Acvity y los datos de los items.
    public AdaptadorChequesTruckSales(IngresarChequesTruckSales activity, List<Cheque> items){
        super();
