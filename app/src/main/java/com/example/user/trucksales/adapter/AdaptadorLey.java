...
public class AdaptadorLey extends BaseAdapter {
    ...
    private final AdaptadorLey adaptador;
    private IngresarDifReten activity; //Activity desde el cual se hace referencia al llenado de la lista
    private List<Diferencia_Reten> arrayItems; // Lista de items

    public AdaptadorLey(IngresarDifReten activity, List<Diferencia_Reten> items){
        super();
