...
import com.example.user.trucksales.Visual.Cobranza.IngresarTarjetaDebito;
...
public class AdaptadorTarjetaDebito extends BaseAdapter {
    ...
    private final AdaptadorTarjetaDebito adaptador;
    private IngresarTarjetaDebito activity; //Activity desde el cual se hace referencia al llenado de la lista
    ...
    public AdaptadorTarjetaDebito(IngresarTarjetaDebito activity, List<TarjetaDebito> items){
        super();
