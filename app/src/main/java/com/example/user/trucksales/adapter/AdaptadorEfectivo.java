...
import com.example.user.trucksales.Visual.Cobranza.IngresarEfectivo;
...
public class AdaptadorEfectivo extends BaseAdapter {
    ...
    private final AdaptadorEfectivo adaptador;
    private IngresarEfectivo activity; //Activity desde el cual se hace referencia al llenado de la lista
    private List<Efectivo> arrayItems; // Lista de items


    // Constructor con parámetros que recibe la Acvity y los datos de los items.
    public AdaptadorEfectivo(IngresarEfectivo activity, List<Efectivo> items){
        super();
