...
public class AdaptadorRetenciones extends BaseAdapter {
    ...
    private final AdaptadorRetenciones adaptador;
    private IngresarRetenciones activity; //Activity desde el cual se hace referencia al llenado de la lista
    ...
    public AdaptadorRetenciones(IngresarRetenciones activity, List<Retenciones> items){
        super();
